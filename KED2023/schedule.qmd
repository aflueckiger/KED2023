...
| 27 April 2023        | [Introduction to Python](lectures.html#week-9-introduction-to-python) + VS Code |
| 04 May 2023          | Pandas und LIRI-Dataset                                      |
| 11 May 2023          | [NLP with Python](lectures.html#week-10-nlp-with-python) |
| ~~18 May 2023~~      | *no lecture (Christi Himmelfahrt)*                           |
| 25 May 2023          | [NLP with Python II + Working Session](lectures.html#week-11-nlp-with-python-ii-working-session) |
| 01 June 2023         | [Mini-Project Presentations + Discussion](lectures.html#week-12-mini-project-presentations-discussion) |
