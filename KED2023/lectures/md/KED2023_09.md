...
1. Create a new file with the following content, save it as `hello_world.py`. Then, execute it by a right click on the code and select  `Run current file in interactive window`.
