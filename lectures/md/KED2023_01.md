...
format:
  revealjs:
    ...
    transition: fade
    preview-links: true
    theme: [default, ../resources/custom_style_reveal.scss]
...
Idea: Recognizing speech regardless of language, accent, speed, noise etc.
...
Idea: Personalizing voice given an audio sample of 3s
...
![ChatGPT may be wrong](../images/chatgpt_university_lucerne.png){.fragment}





![ChatGPT may be wrong](../images/chatgpt_wokeness_rhyme.png){.fragment}
...
![Breakthrough by combining language processing and image generation with Muse MUSE [@Chang2023]](../images/muse_picture_generate.png)
...
![Editing pictures with Muse using natural language [@Chang2023]](../images/muse_picture_edit.png){ height=10cm }
...
![](../images/concepts_ai.png){.l-image-corner height=50%}
